        ...
        <div>
            ...
            <div>
                ...
                <div>
                    ...
                    {`\\begin{aligned}
                    a (-b + y) = 0 & \\implies y = b \\\\
                    (-a x^2 + b) = 0 & \\implies x^2 = b / a \\\\
                    b (a x^2 - y) = 0 & \\implies x^2 = y / a \\\\
                    \\end{aligned}`}
                    ...
                    the intersection object represents $x^2 = b / a$ and $y = b$. This has two solutions {`$x_{1,2} = \\pm \\sqrt{\\frac{b}{a}}$`} as expected 
